...
/* SQL 4: Given the selected term, return all courses with the course number, instructor name, campus, meeting time, and course capacity. */
...
/* SQL 5: Given the student ID, return all the information of this student. */
select *
from student
where nuid = 1;